<table width="195" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <div style="padding-left:5px; padding-top:5px; font-size: 10px;"><strong>&raquo;tuananhtour1310@gmail.com</strong></div>
	
    </div>
    </td>
    <tr>
    	<td height="10px" style="border-bottom: 1px solid #CCCCCC;border-left: 1px solid #CCCCCC;border-right: 1px solid #CCCCCC;">
