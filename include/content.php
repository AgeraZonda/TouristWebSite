...
<div><table width="560" border="0" cellspacing="0" cellpadding="0">
    <tr>
    <td height="40" style="border-bottom:1px solid #333; background:url(images/toplist-content.gif) repeat-x; padding-bottom:5px; font-weight:bold"><font color="#FF0000">Các Loại Xe Nổi Bật</font><img src="images/new.gif" /></td>
